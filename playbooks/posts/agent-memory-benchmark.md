...
The reason to read the rest of this is the evidence. Someone ran eight memory systems through the same test and published the numbers, and the boring approach won by a clear margin.
